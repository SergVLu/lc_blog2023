...
<body>
    ...
    <header class="edica-header edica-landing-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="{{ route('main.index') }}"><img src="{{ asset('assets/images/logo.svg') }}" alt="LC_BLOG2023"></a>
    ...
    <footer class="edica-footer" data-aos="fade-up" style="margin-top:  10px; " style="height: 10px">
        <div class="container">
